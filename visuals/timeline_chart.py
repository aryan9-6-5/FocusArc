...
def plot_timeline_chart(sessions, title="Focus Arc: Daily Timeline"):
    ...
    legend_patches = [Patch(color=c, label=cat.title()) for cat, c in CATEGORY_COLORS.items()]
    ax.legend(handles=legend_patches, title="Categories", bbox_to_anchor=(1.01, 1), loc="upper left")
